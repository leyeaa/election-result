...
<table width="100%">
  <tr>
    <th width="15%" height="98" scope="col">&nbsp;</th>
    <th width="85%" align="left" valign="top" scope="col"><table width="60%" cellpadding="5" cellspacing="1" bgcolor="#999999">
      <tr>
      ...
      <tr>
        <th colspan="7" bgcolor="#FFFFFF" scope="col"><form id="form1" name="form1" method="post" action="select_lg.php">
          <table width="100%" align="left" cellpadding="4" cellspacing="1">
            ...
            <tr>
              <td width="39%" align="right" class="inputs">Local Government Area:</td>
              <td width="61%" align="left" bgcolor="#999999"><label for="agent_name"></label>
            ...
            <tr>
              <td align="right" class="inputs">Select Ward:</td>
              <td align="left" bgcolor="#999999"><label for="ward_id2"></label>
                <div id="cboLGA">
                  <label for="ward_code"></label>
