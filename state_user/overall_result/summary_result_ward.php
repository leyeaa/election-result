...
function total_ward($party_name,$lg_code,$state_code){
	global $database;
...
<table width="100%" cellpadding="5" cellspacing="1" bgcolor="#999999" id="n">
  ...
  <tr align="left">
    ...
    while($rra4=$database->fetch_array($resa4)){
	 ...
	 $result=total_ward($party_name,$lg_code,$state_code); 
...
?>
<table width="34%" cellpadding="4" cellspacing="1" bgcolor="#999999" id="n">
  <tr>
