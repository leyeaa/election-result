...
<table width="100%" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  <tr align="center">
    ...
    <?php
    $sqlaw="SELECT * FROM party"; 
   $resaw=mysql_query($sqlaw) or die(mysql_error());
   while($rraw=mysql_fetch_array($resaw)){ 
   $party_name=$rraw['party_name'];
 ...
 echo"</tr>";					   
  ...
  <tr bgcolor="#FFCCFF">
    ...
    <?php 
	$sqlv3="SELECT * FROM party";
   $resa1v3=mysql_query($sqlv3) or die(mysql_error());
   while($rra13=mysql_fetch_array($resa1v3)){ 
   $party_name=$rra13['party_name'];
