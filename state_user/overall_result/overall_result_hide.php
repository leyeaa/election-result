...
error_reporting(0);
 include("../db/db2.php");	 
 include("../validate/state_result_new.php");  ///remember to committes this when it is real time
//include("../validate/phone_state_result_new.php"); //if phone 
	  $total_sum_LP=0;
	  $total_sum_PDP=0;
	  $total_sum_APC=0;
	   $LP="LP";
...
<table width="100%" cellpadding="3" cellspacing="4" bgcolor="#CCCCCC">
  <tr>
  ...
  <tr>
    <td align="center" bgcolor="#CCCCCC"><img src="../image/apc.jpg" alt="" width="77" height="72" border="1" />AD</td>
