...
<?php
    ...
    while($rr=$database->fetch_array($res)){ 
        ...
        $num=res($rr['party_name'],$state_code);
...
<body>
<table width="80%" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC" id="n">
  <tr>
...
<?php
    ...
    for($i=0;$i<sizeof($party_name);$i++){
        ...
        <td align='right' bgcolor='#FFFFFF'><font size='+3' style='font-family:Tahoma, Geneva, sans-serif; color: #000000; font-size: 35px;'><b>$num2[$i]</b></font></td>
        </tr>";
    }
    $total_gr=number_format($total);
?>
