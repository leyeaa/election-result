...
<meta http-equiv="refresh" content="3 ; http:details_result.php">
...
<table width="100%">
  <tr>
    ...
    <th width="94%" align="left" valign="top" scope="col"><table width="89%" cellpadding="1" cellspacing="1" bgcolor="#999999">
      <tr>
        <th width="100%" bgcolor="#CCCCCC" class="inputs" scope="col">Local Government Area / Polling Units</th>
      </tr>
      <tr>
      ...
      <tr>
        <th bgcolor="#FFFFFF" scope="col"><table width="100%" cellpadding="1" cellspacing="1" bgcolor="#999999">
          <tr>
            <th colspan="3" bgcolor="#FFFFFF" scope="col"><span class="inputs">Local Government Area / Polling Units</span></th>
		  ...
		  $PDP_sum=0;
		  $APC_sum=0;
          $sqlp= "SELECT * FROM polling_unit WHERE lg_id ='$lg_id' ";
	      $resultp=sqlsrv_query($dbconnect,$sqlp) or die(sqlsrv_errors());
          $p=1;
	      while($rowsp=sqlsrv_fetch_array($resultp)){
          $unit_id=$rowsp['unit_id'];
		  $agent_name=$rowsp['agent_name'];
		  $agent_phone=$rowsp['agent_phone'];
          $sqlr="SELECT * FROM result WHERE unit_id='$unit_id'";
          ...
          echo"<tr class='inputs'>
            ...
            <td width='55%' align='right' bgcolor='#FFFFFF'> $agent_name-$agent_phone &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$rowsp['unit_name']}:</td>
