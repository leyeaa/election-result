...
$msg2=addslashes($rows['MessageText']);
...
$security_message=trim(strtoupper($arry_msg2[2])); // what message
	...
	$sqly="INSERT INTO wrong_messagein SET MessageFrom='$receiver',MessageText='$msg2',state_code='$state_code'";
	$database->query($sqly) or die($database->error());
	//-------------------- to all 2
	$sqly2="INSERT INTO all_messagein SET MessageFrom='$receiver',MessageText='$msg2',state_code='$state_code'";
	$database->query($sqly2) or die($database->error());
	   }
//---------------------------------------- save the incoming message to another table database
     /*if($go=="To"){  //yes this may likely  be removed 
	$sqly="INSERT INTO wrong_messagein SET MessageFrom='$receiver',MessageText='$msg2'";
	$database->query($sqly) or die($database->error());
	 }}*/
	 //=========
	 /* if($all=="go"){//yes
	...
	$database->query($sqly) or die($database->error());
	//-------------------- to all 2
	$sqly2="INSERT INTO all_messagein SET MessageFrom='$receiver',MessageText='$msg2'";
	$database->query($sqly2) or die($database->error());
	  }*/
//------------------------------------------------------------------------------------------------------------------------------------------------------------------
